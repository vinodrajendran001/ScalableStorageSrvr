...
public interface KVActionsInterface {
	 ...
	 * call launches the server. You can assume that the KVServer.jar is located
	 * in the same directory as the ECS. All servers are initialized with the
	 * meta-data and remain in state stopped.
	 */
